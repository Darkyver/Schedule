...
public class AddPaymentController extends AbstractController implements Initializable {
    ...
    public AddPaymentController(User user) {
        this.user = user;
    }
    ...
    public void btnApply(ActionEvent event) {
        ...
        boolean res = getConfig().addNewPaymentsToUser(user.getId(), amount, time);
